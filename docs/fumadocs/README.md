...
This Fumadocs setup coexists with the existing Sphinx documentation in the parent `docs` directory:

- **Sphinx docs**: Traditional RST-based documentation in `docs/src/main/sphinx/`
- **Fumadocs**: Modern React-based documentation in `docs/fumadocs/`

Both documentation systems can be maintained simultaneously during a transition period.
