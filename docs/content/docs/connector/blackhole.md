---
title: Blackhole
description: Blackhole documentation
---
...
The connector provides [globally available <sql-globally-available>](#globally available <sql-globally-available>),
[read operation <sql-read-operations>](#read operation <sql-read-operations>), and supports the following
additional features:

- [/sql/insert](/docs//sql/insert)
- [/sql/update](/docs//sql/update)
- [/sql/delete](/docs//sql/delete)
- [/sql/merge](/docs//sql/merge)
- [/sql/create-table](/docs//sql/create-table)
- [/sql/create-table-as](/docs//sql/create-table-as)
- [/sql/show-create-table](/docs//sql/show-create-table)
...
- [/sql/create-view](/docs//sql/create-view)
