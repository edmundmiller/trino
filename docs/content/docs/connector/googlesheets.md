---
title: Googlesheets
description: Googlesheets documentation
---
...
connector [modifies some types <type-mapping-overview>](#modifies some types <type-mapping-overview>) when reading data.
...
In addition to the [globally available <sql-globally-available>](#globally available <sql-globally-available>) and [read operation <sql-read-operations>](#read operation <sql-read-operations>) statements,
...
The connector provides specific [/functions/table](/docs//functions/table) to access Google Sheets.
