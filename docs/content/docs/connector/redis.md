...
Please refer to the [Kafka connector](/docs/connector/kafka) page for the description of the `dataFormat` as well as various available decoders.
...
connector [maps some types <type-mapping-overview>](#maps some types <type-mapping-overview>) when reading data. Type
...
<!-- Fragment not found: csv-decoder.fragment -->

<!-- Fragment not found: json-decoder.fragment -->

<!-- Fragment not found: avro-decoder.fragment -->

## SQL support

The connector provides [globally available <sql-globally-available>](#globally available <sql-globally-available>) and
[read operation <sql-read-operations>](#read operation <sql-read-operations>) statements to access data and
metadata in Redis.
