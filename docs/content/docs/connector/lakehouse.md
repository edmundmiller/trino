---
title: Lakehouse
description: Lakehouse documentation
---
# Lakehouse connector
...
[Hive](/docs/connector/hive), [Iceberg](/docs/connector/iceberg),
[Delta Lake](/docs/connector/delta-lake), and [Hudi](/docs/connector/hudi)
...
You must configure a [AWS Glue or a Hive metastore](/docs/object-storage/metastores).
