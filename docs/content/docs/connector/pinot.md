---
title: Pinot
description: Pinot documentation
---
# Pinot connector
...
You can use [secrets ](/docs//security/secrets) to avoid actual values in the catalog properties files.
...
connector [maps some types <type-mapping-overview>](#maps some types <type-mapping-overview>) when reading data.
