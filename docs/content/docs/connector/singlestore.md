---
title: Singlestore
description: Singlestore documentation
---
...
| `DOUBLE` | `DOUBLE` |  |
| `REAL` | `DOUBLE` |  |
| `DECIMAL(p, s)` | `DECIMAL(p, s)` | See [Singlestore DECIMAL type handling](singlestore-decimal-handling) |
| `CHAR(n)` | `CHAR(n)` |  |
...
a SingleStore database.  In addition to the [globally available
