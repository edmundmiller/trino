...
- Write access to the [schema information collection <table-definition-label>](#schema information collection <table-definition-label>)
  in MongoDB.
...
[schema information collection <table-definition-label>](#schema information collection <table-definition-label>).
...
As MongoDB is a document database, there is no fixed schema information in the system. So a special collection in each MongoDB database should define the schema of all tables. Please refer the [table-definition-label](#table-definition-label) section for the details.

At startup, the connector tries to guess the data type of fields based on the [type mapping <mongodb-type-mapping>](#type mapping <mongodb-type-mapping>).

The initial guess can be incorrect for your specific collection. In that case, you need to modify it manually. Please refer the [table-definition-label](#table-definition-label) section for the details.
...
The path to the [PEM ](/docs//security/inspect-pem) or
[JKS ](/docs//security/inspect-jks) key store.

This property is optional.

### `mongodb.tls.truststore-path`

The path to [PEM ](/docs//security/inspect-pem) or
[JKS ](/docs//security/inspect-jks) trust store.
...
MongoDB. In addition to the [globally available
