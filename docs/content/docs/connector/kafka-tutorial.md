...
description: Kafka Tutorial documentation
---
# Kafka connector tutorial

## Introduction

The [kafka](/docs/kafka) for Trino allows access to live topic data from
...
installation (see [/installation/deployment](/docs//installation/deployment)). It focuses on
...
Start the [Trino CLI ](/docs//client/cli):
...
in JSON format, the [/functions/json](/docs//functions/json) built into Trino can be used
to slice the data.
