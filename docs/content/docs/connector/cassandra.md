---
title: Cassandra
description: Cassandra documentation
---
# Cassandra connector
...
| `cassandra.allow-drop-table`     | Enables [/sql/drop-table](/docs//sql/drop-table) operations. Defaults to `false`.                                                                                                                                                                                                                                                                                                                                                             |
...
| `cassandra.partition-size-for-batch-select`                | Number of partitions batched together into a single select for a single partition key column table.                                                                                                                                                                                                                                                                                             |
...
| `cassandra.tls.keystore-path`                              | Path to the [PEM ](/docs//security/inspect-pem) or [JKS ](/docs//security/inspect-jks) key store file.                                                                                                                                                                                                                                                                                           |
| `cassandra.tls.truststore-path`                            | Path to the [PEM ](/docs//security/inspect-pem) or [JKS ](/docs//security/inspect-jks) trust store file.                                                                                                                                                                                                                                                                                         |
...
the Cassandra database. In addition to the [globally available
...
- [/sql/delete](/docs//sql/delete) see [sql-delete-limitation](#sql-delete-limitation)
