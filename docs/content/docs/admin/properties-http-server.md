---
title: Properties Http Server
description: Properties Http Server documentation
---
...
API](/docs/develop/client-protocol).
...
types](/docs/security/authentication-types).
...
shared secret](/docs/security/internal-communication).
...
communication](/docs/security/internal-communication) between all
