---
title: Preview Web Interface
description: Preview Web Interface documentation
---
# Preview Web UI
...
Typically, a password-based authentication method such as [LDAP](/docs/security/ldap)
or [password file](/docs/security/password-file) is used to secure both the Trino
