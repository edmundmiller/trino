---
title: Event Listeners Mysql
description: Event Listeners Mysql documentation
---
...
in MySQL or via Trino in a catalog using the [MySQL connector](/docs/connector/mysql).
