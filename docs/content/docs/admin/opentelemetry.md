---
title: Opentelemetry
description: Opentelemetry documentation
---
...
Install and run the [Trino CLI](/docs/client/cli) or any other client application and
submit a query such as `SHOW CATALOGS;` or `SELECT * FROM tpch.tiny.nation;`.

Optionally, log into the [Trino Web UI](/docs/admin/web-interface) at
