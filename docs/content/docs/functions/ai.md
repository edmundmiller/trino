...
property](/docs/admin/properties-sql-environment) in the `config.properties` file to
...
Use [secrets](/docs/security/secrets) to avoid actual API key values in the catalog
properties files.
