...
description: Create Function documentation
---
# CREATE FUNCTION
...
storage catalog and schema](/docs/admin/properties-sql-environment) are configured.
...
UDF examples documentation](/docs/udf/sql/examples).
