---
title: Drop Function
description: Drop Function documentation
---
# DROP FUNCTION
...
qualified with catalog and schema location of the UDF, unless the [default UDF storage catalog and schema](/docs/admin/properties-sql-environment) are
configured.
...
storage](/docs/admin/properties-sql-environment) is configured, you can use the
