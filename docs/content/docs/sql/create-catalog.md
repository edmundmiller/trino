...
description: Create Catalog documentation
---
# CREATE CATALOG
...
documentation](/docs/connector) to learn about all available properties. All
...
environmental variables are set as [secrets](/docs/security/secrets) on all nodes of
the cluster.
