...
description: Client Protocol documentation
---
# Client protocol

The Trino client protocol is a HTTP-based protocol that allows
[clients](/docs/client) to submit SQL queries and receive results.
...
> **Note:** The `protocol.spooling.shared-secret-key` property requires a 256-bit,
...
API developer reference](/docs/develop/client-protocol).
